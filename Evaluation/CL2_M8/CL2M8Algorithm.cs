...
namespace CL2_M8
{
    public sealed class CL2M8Algorithm : SosielAlgorithm<CL2M8Agent>, IAlgorithm
    {
        ...
        public CL2M8Algorithm(Configuration<CL2M8Agent> configuration) : base(configuration.AlgorithmConfiguration, GetProcessConfiguration())
        {
